    ...
    return (
			<div className='max-w-[1250px]'>
				<div>
						...
						<aside>
							<div className="flex">
								<img
									...
									alt=""
								/>
								<a className="flex-1 btn btn-ghost text-xl">HERO.IO</a>
							</div>
						</aside>
						<nav>
							<h6 className="footer-title">Social Media handles</h6>
					...
					<p className="text-center py-4 bg-black text-gray-600">
